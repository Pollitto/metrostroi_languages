...
Train.Common.PneumoPanels   = Valvola pneumatica #FIXME
Train.Common.Voltmeters     = Voltometro e amperometro #FIXME
...
Entities.gmod_subway_81-717_mvm_custom.Name     = 81-717 (Moscow personalizzato) #FIXME
...
Entities.gmod_train_special_box.Name        = Consegna speciale #FIXME

#Weapons
Weapons.button_presser.Name                 = Premi bottoni #FIXME
Weapons.button_presser.Purpose              = Usato per premere i bottoni della mappa. #FIXME
Weapons.button_presser.Instructions         = Guarda il pulsante e fai clic sul pulsante "Attacca". #FIXME
Weapons.train_key.Name                      = Chiave dell'amministratore #FIXME
Weapons.train_key.Purpose                   = Utilizzato per premere i pulsanti degli amministratori. #FIXME
Weapons.train_key.Instructions              = Guarda il pulsante amministratore e premi il pulsante "Attacca". #FIXME
Weapons.train_kv_wrench.Name                = Chiave dell'invertitore #FIXME
Weapons.train_kv_wrench.Purpose             = Utilizzato nel treno per premere i pulsanti in essi. #FIXME
Weapons.train_kv_wrench.Instructions        = premi il pulsante "Attacca" per interagire col treno. #FIXME
Weapons.train_kv_wrench_gold.Name           = La chiave dell'invertitore dorata #FIXME
...
#Spawner common
Spawner.Title                           = Spawner di treni #FIXME
Spawner.Spawn                           = Spawn #FIXME
Spawner.Close                           = Chiudi #FIXME
Spawner.Trains1                         = Wags. permesso #FIXME
Spawner.Trains2                         = Per player #FIXME
Spawner.WagNum                          = Numero di vagoni #FIXME
...
Common.Spawner.SpawnMode                = Stato del treno #FIXME
Common.Spawner.SpawnMode.Deadlock       = Completamente spento #FIXME
Common.Spawner.SpawnMode.Full           = Completamente pronto #FIXME
Common.Spawner.SpawnMode.NightDeadlock  = Completamente spento dopo la notte #FIXME
Common.Spawner.SpawnMode.Depot          = Deposito #FIXME
Spawner.Common.EType                    = Circuiti elettrici type #FIXME
Common.Spawner.Scheme                   = Schema linea
Common.Spawner.Random                   = Casuale #FIXME
Common.Spawner.Old                      = Vecchio #FIXME
Common.Spawner.New                      = Nuovo #FIXME
Common.Spawner.Type                     = Tipo #FIXME
Common.Spawner.SchemeInvert             = Inverti schema linea

#Coupler common
Common.Couple.Title         = Menu accoppiatore #FIXME
Common.Couple.CoupleState   = Stato dell' accoppiatore #FIXME
Common.Couple.Coupled       = Accoppiato #FIXME
Common.Couple.Uncoupled     = Non accoppiato #FIXME
Common.Couple.Uncouple      = Sgancia #FIXME
Common.Couple.IsolState     = Stato delle valvole di isolamento #FIXME
Common.Couple.Isolated      = Isolato #FIXME
Common.Couple.Opened        = Aperto #FIXME
Common.Couple.Open          = Apri #FIXME
Common.Couple.Isolate       = Isola #FIXME
Common.Couple.EKKState      = EKK stato (Connessione elettrica) #FIXME
Common.Couple.Disconnected  = Disconesso #FIXME
Common.Couple.Connected     = Connesso #FIXME
Common.Couple.Connect       = Connetti #FIXME
Common.Couple.Disconnect    = Disconetti #FIXME

#Bogey common
Common.Bogey.Title              = Menu carrello #FIXME
Common.Bogey.ContactState       = Stato attuale dei contatti #FIXME
Common.Bogey.CReleased          = Rilasciato #FIXME
Common.Bogey.CPressed           = Premuto #FIXME
Common.Bogey.CPress             = Premi #FIXME
Common.Bogey.CRelease           = Rilascia #FIXME
Common.Bogey.ParkingBrakeState  = Stato freno di parcheggio #FIXME
Common.Bogey.PBDisabled         = Disabilitato manualmente #FIXME
Common.Bogey.PBEnabled          = Abilitato #FIXME
Common.Bogey.PBEnable           = Abilita #FIXME
Common.Bogey.PBDisable          = Disabilitazione manuale #FIXME

#Trains common
Common.ALL.Unsused1                         = Non utilizzato
Common.ALL.Unsused2                         = (non utilizzato)
Common.ALL.Up                               = (su) #FIXME
Common.ALL.Down                             = (giù) #FIXME
Common.ALL.Left                             = (sinistra) #FIXME
Common.ALL.Right                            = (destra) #FIXME
Common.ALL.CW                               = (senzo orario) #FIXME
Common.ALL.CCW                              = (Contatore senzo orario) #FIXME
...
Common.ALL.KAHK                             = KAH Copri bottone #FIXME
...
Common.ALL.VSD                              = Selettore lato di apertura porte #FIXME
...
Common.ALL.VRPBV                            = VRP: Ripristinare il relè di sovraccarico, abilitare BV #FIXME
Common.ALL.KSN                              = KSN: Segnalatore di malfunzionamento
Common.ALL.VMK                              = VMK: Compressore
Common.ALL.MK                               = Compressore #FIXME (without acronym)
...
Common.ALL.PassLights                       = Luci compartimento passeggieri #FIXME
Common.ALL.PanelLights                      = Illuminazione del pannello di controllo #FIXME
...
Common.ALL.BrW                              = Freni pneumatici dei vagoni in funzione #FIXME
...
Common.ALL.RCARS                            = RC-ARS: I circuiti del ARS si sono disconessi #FIXME (same as RC-1)
...
Common.ARS.VP                               = Modalità "Treno ausiliario" #FIXME
...
Common.ARS.N4                               = NCh: Nessuna frequenza ARS #FIXME (same as OCh but NCh)
...
Common.ALL.LSD                              = Luce indicatore delle porte del treno (le porte sono chiuse) #FIXME
...
Common.ALL.DriverValveDisconnect            = Valvola di disconnessione valvola del conducente #FIXME
Common.ALL.KRMH                             = KRMSH: Abilitazione di emergenza della valvola del conducente #FIXME
Common.ALL.RVTB                             = RVTB: Valvola riservata del freno di sicurezza #FIXME
...
Common.ALL.UAVA2                            = UAVA: Abilita la disabilitazione automatica dell'autostop #FIXME
...
Common.ALL.PassDoor                         = Porta dell'abitacolo #FIXME
Common.ALL.FrontDoor                        = Porta anteriore
Common.ALL.RearDoor                         = Porta posteriore
Common.ALL.OtsekDoor1                       = Prima maniglia armadietto #FIXME
Common.ALL.OtsekDoor2                       = Seconda maniglia armadietto #FIXME
Common.ALL.CouchCap                         = Tira fuori il sedile #FIXME
...
#PVK
Common.CabVent.PVK-         = Diminuisci potenza ventilazione cabina #FIXME
Common.CabVent.PVK+         = Aumenta potenza ventilazione cabina #FIXME
...
Common.IGLA.Button23        = IGLA: Secondo e terzo pulsante #FIXME
Common.IGLA.Button3         = IGLA: Terzo pulsante #FIXME
Common.IGLA.Button4         = IGLA: Quarto pulsante #FIXME
...
Common.BZOS.VH1     = Allarme di sicurezza attivo #FIXME
Common.BZOS.VH2     = Allarme di sicurezza innescato #FIXME
Common.BZOS.Engaged = Allarme innescato #FIXME

#Train helpers common
Common.ALL.SpeedCurr        = Velocità effettiva #FIXME
Common.ALL.SpeedAccept      = Velocità autorizzata #FIXME
Common.ALL.SpeedAttent      = Velocità autorizzate al prossimo segmento #FIXME
...
Common.ALL.EnginesCurrent1  = Corrente di trazione motore 1 (A) #FIXME
Common.ALL.EnginesCurrent2  = Corrente di trazione motore 2 (A) #FIXME
Common.ALL.EnginesVoltage   = Voltaggio motori (kV)
Common.ALL.BatteryVoltage   = Voltaggio batteria (V)
Common.ALL.BatteryCurrent   = Corrente batteria (A) #FIXME
