...
#######Buttons###########
#Common
Common.502.KS                   = Indicateur d'opération KSAUP
Common.502.AV                   = La conduite automatique est engagée
Common.502.SD                   = SD: Etat des portes (les portes sont ouvertes)
Common.502.SDW                  = SD: Etat des portes (les portes sont fermées)
Common.502.L3w                  = Lampe du 3ème câble (mode X3)
Common.502.L4w                  = Lampe du 4ème câble (direction : marche avant)
Common.502.L5w                  = Lampe du 5ème câble (direction : marche arrière)
...
Entities.gmod_subway_81-502.Buttons.AV.VRUToggle = VRU: Mode de conduite d'urgence
Entities.gmod_subway_81-502.Buttons.AV.KPVUToggle = KPVU: Coupe le désactivateur de contrôle pneumatique
Entities.gmod_subway_81-502.Buttons.AV.KSDToggle = KSD: Contrôle du verrouillage des portes
...
Entities.gmod_subway_81-502.Buttons.RCAV3.RCAV3Toggle           = Déconnecteur des circuits KSAUP (AV3)
Entities.gmod_subway_81-502.Buttons.RCAV4.RCAV4Toggle           = Déconnecteur des circuits KSAUP (AV4)
Entities.gmod_subway_81-502.Buttons.RCAV5.RCAV5Toggle           = Déconnecteur des circuits KSAUP(AV5)
