...
Workshop.FilesMissing       = Missing some addon files or addon has corrupted.\nIf addons has installed from Workshop, try to delete a file:\nGarrysMod/garrysmod/%s.
Workshop.FilesMissingLocaly = Missing some addon files or addon has corrupted.
...
Panel.SoftDraw          = Percent of the "smooth"\nloading of an elements
...
Entities.gmod_subway_em508t.Name      = 81-508Т (Em-508T intermediate)
...
Common.ALL.VU                               = VU: Train control
Common.ALL.KDP                              = Open right doors
Common.ALL.KDPK                             = Right doors button cover
Common.ALL.KDL                              = Open left doors
...
Common.ALL.VUD2                             = Close doors from the helper's side
Common.ALL.Program1                         = Program I
Common.ALL.Program2                         = Program II
Common.ALL.VRP                              = Reset overload relay
Common.ALL.KSN                              = KSN: Malfunction signalling
Common.ALL.VMK                              = MK: Compressor
...
Common.ALL.RCARS                            = RC-1: ARS circuits disconnect
...
Common.ARS.Freq                             = Decoder switch
...
Common.ARS.AV                               = Main ARS-MP unit fault
Common.ARS.AV1                              = Spare ARS-MP unit fault
...
Common.ARS.40                               = Speed limit 40 kph
Common.ARS.60                               = Speed limit 60 kph
Common.ARS.70                               = Speed limit 70 kph
Common.ARS.80                               = Speed limit 80 kph
Common.ALL.RCBPS                            = Anti-Rolling unit switch
Common.BPS.On                               = Anti-Rolling unit operation
Common.BPS.Err                              = Anti-Rolling unit error
Common.BPS.Fail                             = Anti-Rolling unit fault
...
Common.ALL.OAVU                             = Disable AVU switch
Common.ALL.LAVU                             = AVU is activated
Common.ALL.GV                               = Main switch
Common.ALL.AirDistributor                   = Air disctributor disabler
...
Common.ALL.EnginesCurrent   = Engines current
Common.ALL.EnginesVoltage   = Engines voltage
Common.ALL.BatteryVoltage   = Battery voltage
Common.ALL.HighVoltage      = High voltage
]]