...
Common.ALL.KAHK                             = Крышка кнопки КАХ #FIXME
...
Common.ALL.ParkingBrake                     = Стояночный тормоз #FIXME
Common.ALL.VU                               = VU: Train control
Common.ALL.KDP                              = KDP: Open right doors
Common.ALL.KDPL                             = Лампа выбора правой стороны дверей #FIXME
Common.ALL.KDPK                             = Right doors button cover
Common.ALL.KDL                              = KDL: Open left doors
Common.ALL.KDLL                             = Лампа выбора левой стороны дверей #FIXME
...
Common.ALL.KRMH                             = KRMSH: Brake lever emergency enable #FIXME
...
Common.ALL.CouchCap                         = Folding seat #FIXME
