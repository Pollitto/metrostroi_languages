...
Entities.gmod_subway_81-723.Name      = 81-723 (Jubilejnij vložený motorový)
Entities.gmod_subway_81-724.Name      = 81-724 (Jubilejnij vložený nemotorový)
...
Common.ALL.RRP                              = RP: Červené světlo přetížení relé (nelze zkompletovat jističe)
Common.ALL.GRP                              = RP: Zelené světlo přehřátí relé (zabraňuje nadproudu trakčních motorů)
Common.ALL.RP                               = RP: Červené světlo přetížení relé (nelze zkompletovat jističe, nebo přehřátí relé)
Common.ALL.SN                               = LSN: Přetížení relé (nelze zkompletovat jističe)
Common.ALL.PU                               = Režim sníženého výkonu zapnut
Common.ALL.BrT                              = Pneumatické brzdy vlaku zapojeny
Common.ALL.BrW                              = Pneumatické brzdy vozu zapojeny
...
Common.ARS.ABButton                         = Tlačítko: Provoz v režimu automatického bloku
Common.ARS.ABDriver                         = (strojvedoucího)
Common.ARS.ABHelper                         = (pomocníka strojvedoucího)
...
Common.ALL.LSD                              = Signalizace zavření dveří (dveře jsou zavřeny)
...
Common.ALL.SpeedAttent      = Předvěst (povolená rychlost v příštím obvodu)
