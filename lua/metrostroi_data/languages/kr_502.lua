...
Common.502.L4w                  = 차량 회로 4 표시등 (후진 방향)
Common.502.L5w                  = 차량 회로 5 표시등 (전진 방향)
Common.502.L16w                 = 차량 회로 16 표시등 (출입문 연동)
Common.502.L20w                 = 차량 회로 20 표시등 (LK2/LK5 차단, 부드럽게 분리)
Common.502.L23w                 = 차량 회로 23 표시등 (공기 압축기 제어)
Common.502.RK1                  = 첫번째 RK 위치 제어
Common.502.BRD                  = 출입문 고장 표시등
Common.502.KOS                  = KB: 속도 제한 버튼 (확인 버튼)
Common.502.VAK                  = AK: 비상 주행 모드 회로 연결
Common.502.LRU                  = 비상 주행 모드 회로 작동 중
#gmod_subway_81-502
Entities.gmod_subway_81-502.Buttons.VBA.VBAToggle = 자동 운전 배터리 투입/차단

Entities.gmod_subway_81-502.Buttons.AV.VRUToggle = VRU: 비상 운전 모드
Entities.gmod_subway_81-502.Buttons.AV.KPVUToggle = KPVU: 공압 밸브 제동 비활성기 사용 중지
Entities.gmod_subway_81-502.Buttons.AV.KSDToggle = KSD: 출입문 연동 제어 사용 중지
