...
Common.ALL.KDP                              = KDP: 우측 출입문 개방
Common.ALL.KDPK                             = 우측 출입문 개방 버튼 커버
Common.ALL.KDL                              = KDL: 좌측 출입문 개방
Common.ALL.KDLK                             = 좌측 출입문 개방 버튼 커버
Common.ALL.KDLPK                            = 출입문 버튼 커버
Common.ALL.KRZD                             = KRZD: 출입문 강제 닫힘
Common.ALL.Ring                             = 부저
Common.ALL.VUD                              = VUD: 출입문 제어 스위치 (출입문 닫힘)
Common.ALL.KDPH                             = 마지막 객차 우측 출입문 개방
...
Common.ALL.GRP                              = RP: 과전류 계전기 확인등(녹색) (추진장치 과전류 방지)
...
Common.ARS.AV                               = 주 ARS-MP 장치 고장
Common.ARS.AV1                              = 보조 ARS-MP 장치 고장
...
Common.ALL.L1w                              = 차량 회로 1 표시등 (주행 모드 작동)
