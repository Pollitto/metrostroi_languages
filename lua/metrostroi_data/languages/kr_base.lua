...
Common.ALL.KAHK                             = KAX 버튼 커버 #FIXME
...
Common.ALL.VRPBV                            = VRP: 과전류 계전기 리셋, BV 사용 #FIXME
Common.ALL.KSN                              = KSN: 오작동 신호 전달
Common.ALL.VMK                              = VMK: 공기 압축기
Common.ALL.MK                               = 공기 압축기 #FIXME (without acronym)
...
Common.ALL.PassLights                       = 객실 내부 조명 #FIXME
Common.ALL.PanelLights                      = 운전대 조명 #FIXME
...
Common.ALL.RouteNumber1+                    = 경로 번호: 일의 자리 증가
Common.ALL.RouteNumber1-                    = 경로 번호: 일의 자리 감소
Common.ALL.RouteNumber2+                    = 경로 번호: 십의 자리 증가
Common.ALL.RouteNumber2-                    = 경로 번호: 십의 자리 감소
Common.ALL.RouteNumber3+                    = 경로 번호: 백의 자리 증가
Common.ALL.RouteNumber3-                    = 경로 번호: 백의 자리 감소
...
Common.ARS.N4                               = NCh: ARS 신호 없음 #FIXME (same as OCh but NCh)
Common.ARS.0                                = 0: ARS 정지 신호
Common.ARS.40                               = 속도 제한 40 kph
Common.ARS.60                               = 속도 제한 60 kph
Common.ARS.70                               = 속도 제한 70 kph
Common.ARS.80                               = 속도 제한 80 kph
...
Common.ALL.UAVA2                            = UAVA: 자동 정지 장치 사용 중지 #FIXME
...
Common.ALL.PassDoor                         = 객실 문 #FIXME
Common.ALL.FrontDoor                        = 관통 문
Common.ALL.RearDoor                         = 관통 문
Common.ALL.OtsekDoor1                       = 1번 장비함 손잡이 #FIXME
Common.ALL.OtsekDoor2                       = 2번 장비함 손잡이 #FIXME
Common.ALL.CouchCap                         = 의자 당기기 #FIXME
...
#PVK
Common.CabVent.PVK-         = 운전실 환풍기 세기: - #FIXME
Common.CabVent.PVK+         = 운전실 환풍기 세기: + #FIXME
...
Common.IGLA.Button23        = IGLA: [버튼 2/3] #FIXME
Common.IGLA.Button3         = IGLA: [버튼 3] #FIXME
Common.IGLA.Button4         = IGLA: [버튼 4] #FIXME
...
#BZOS
Common.BZOS.On      = 보안 경보 스위치 #FIXME
Common.BZOS.VH1     = 보안 경보 작동 중 #FIXME
Common.BZOS.VH2     = 보안 경보 감지 됨 #FIXME
Common.BZOS.Engaged = 보안 경보 감지 됨 #FIXME

#Train helpers common
Common.ALL.SpeedCurr            = 실제 속도 #FIXME
Common.ALL.SpeedAccept          = 허용 속도 #FIXME
Common.ALL.SpeedAttent          = 다음 구간 허용 속도 #FIXME
...
Common.ALL.EnginesCurrent1   = 1번 견인 전동기 전류계 (A) #FIXME
Common.ALL.EnginesCurrent2   = 2번 견인 전동기 전류계 (A) #FIXME
