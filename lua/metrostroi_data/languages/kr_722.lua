...
Train.722.PU2_1         = 버튼 패널
Train.722.PU2_2         = 보조 패널
Train.722.Vityaz        = SAU "VITYAZ-SP" 모니터
Train.722.SARMAT        = CIS 시스템 모니터
Train.722.CabLights     = 운전실 조명 패널
Train.722.Disconnects   = 차단 밸브류
Train.722.KRMH           = KRMSH, RVTB 밸브

#######Buttons###########
Common.722.MirrorHeating                = 반사경 히터
Common.722.EmergencyDrive               = 비상 운전 모드 - 비상 기동
Common.722.Microphone                   = 마이크 작동
Common.722.LRS                          = 무선국 배터리 비상 전원 #indicator
Common.722.LAVS                         = 제동관 압력 부족 #indicator
Common.722.LRU                          = 제어 계전기 꺼짐 #indicator
Common.722.GlassWasher                  = 전면 창 워셔
Common.722.GlassCleaner                 = 전면 창 와이퍼
Common.722.EmergencyBrakeTPlus          = 비상 제동 (T+ 모드)
Common.722.EmergencyBrakeTPlusK         = "비상 제동" 버튼 커버
Common.722.KRO                          = 진행 방향

Common.722.PSNToggle                    = 배터리 충전 (외부 전원 사용)
Common.722.BattOn                       = 열차 전원 공급 장치 작동
Common.722.BattOff                      = 열차 전원 공급 장치 작동 중지
Common.722.TorecDoorUnlock              = 통로문 잠금 해제
Common.722.SCEnabled                    = 단락 장치 작동
Common.722.LSOSD                        = 스크린도어 표시등 점등 #indicator

Common.722.PassVent                     = 객실 환풍기
Common.722.VRU                          = 제어 모드 스위치
Common.722.VADToggle                    = 출입문 인터록 미사용 주행
Common.722.VAHToggle                    = 확인 페달 미사용 주행
Common.722.EmergencyRadioPowerToggle    = 무선국 비상 전원
Common.722.BARSMode                     = BARS 모드 스위치
Common.722.PantSC                       = 집전 장치, 단락기

Common.SARMAT.Up                        = SARMAT: 위
Common.SARMAT.Down                      = SARMAT: 아래
...
Common.SARMAT.Path                      = SARMAT: 방향
Common.SARMAT.Line                      = SARMAT: 노선
Common.SARMAT.Zero                      = SARMAT: 시작으로 설정
Common.SARMAT.Start                     = SARMAT: 시작

#Autobreakers
Common.722.SF1                          = SF1: 차량 전원선 (제어)
Common.722.SF2                          = SF2: 운전실 활성
Common.722.SF3                          = SF3: 주 제어
Common.722.SF4                          = SF4: 비상 제어
Common.722.SF5                          = SF5: RVTB 제어
Common.722.SF6                          = SF6: 제동변 전원
Common.722.SF7                          = SF7: 출입문 제어
...
Common.722.SF12                         = SF12: 화재 경보
Common.722.SF13                         = SF13: @[Common.722.PantSC]
Common.722.SF14                         = SF14: 무선 교신 1
Common.722.SF15                         = SF15: 무선 교신 2
Common.722.SF16                         = SF16: CIS 1 (모니터)
Common.722.SF17                         = SF17: CIS 2 (중앙 정보 시스템)
Common.722.SF18                         = SF18: CIS 3
Common.722.SF19                         = SF19: BUKP, UPI
Common.722.SF20                         = SF20: 모니터
Common.722.SF21                         = SF21: 방향
Common.722.SF22                         = SF22: 적색등 전원 (배터리)
Common.722.SF23                         = SF23: 전조등, 적색등
Common.722.SF24                         = SF24: 스크린도어 열림 확인등
Common.722.SF25                         = SF25: 운전실 조명
Common.722.SF26                         = SF26: 운전실 냉난방기
Common.722.SF27                         = SF27: 전면 창 와이퍼, 워셔, 경적

Common.722.SF31                         = SF31: 차량 전원선
Common.722.SF32                         = SF32: 차량 전원선 (제어)
Common.722.SF33                         = SF33: 제어 회로 전원
Common.722.SF34                         = SF34: 좌측 CIS
Common.722.SF35                         = SF35: 우측 CIS
Common.722.SF36                         = SF36: 외부 차량 상태 확인등
Common.722.SF37                         = SF37: 집전 장치 비활성
Common.722.SF38                         = SF38: 예비
Common.722.SF41                         = SF41: 좌측 출입문 열림
Common.722.SF42                         = SF42: 우측 출입문 열림
Common.722.SF43                         = SF43: 출입문 닫힘
Common.722.SF44                         = SF44: 통로문
Common.722.SF45                         = SF45: 객실 조명 전원
Common.722.SF46                         = SF46: 객실 비상 조명
Common.722.SF47                         = SF47: 1번 환풍기 그룹
Common.722.SF48                         = SF48: 2번 환풍기 그룹
Common.722.SF49                         = SF49: 계수기
Common.722.SF51                         = SF51: 객차 제어 유닛
Common.722.SF52                         = SF52: BODV
Common.722.SF53                         = SF53: PSN (전원 공급 장치)
Common.722.SF54                         = SF54: 공기 압축기 공기 건조기
Common.722.SF55                         = SF55: BUFT (마찰 제동 제어 유닛)
Common.722.SF56                         = SF56: 인버터
Common.722.SF57                         = SF57: 인버터 히터
Common.722.SF58                         = SF58: 객차 제어 회로 주 전원
Common.722.SF59                         = SF59: 객차 제어 회로 비상 전원
