...
Panel.ReloadClient      = Redémarre le client
...
Common.ALL.RCARS                            = RC-1: Déconnexion des circuits de l'ARS
...
Common.IGLA.Button1Down     = IGLA: Premier bouton down
Common.IGLA.Button2Up       = IGLA: Deuxième bouton haut
Common.IGLA.Button2         = IGLA: Deuxième bouton
Common.IGLA.Button2Down     = IGLA: Deuxième bouton down
