...
#######Buttons###########
#Common
Common.502.KS                   = KSAUP üzem visszajelző
Common.502.AV                   = Automatikus vonatvezérlés üzemben
Common.502.SD                   = SD: Ajtó állapot (Ajtók zárva)
Common.502.SDW                  = SD: Ajtó állapot (Ajtók nyitva)
Common.502.L3w                  = Harmadik visszajelző lámpa (X3 mód)
Common.502.L4w                  = Negyedik visszajelző lámpa (hátramenet)
Common.502.L5w                  = Ötödik visszajelző lámpa (előremenet)
Common.502.L16w                 = Hatodik visszajelző lámpa (ajtó retesz)
Common.502.L20w                 = Huszadik visszajelző lámpa (LK2 és LK5 zárt)
Common.502.L23w                 = Huszonharmadik visszajelző lámpa (kompresszor vezérlés)
Common.502.RK1                  = Első RK pozíció vezérlése
Common.502.BRD                  = Ajtóhiba visszajelző
Common.502.KOS                  = KB: Sebességhatár gomb (éberségi gomb)
Common.502.VAK                  = AK: Szükségmenet áramkörei gomb
Common.502.LRU                  = Szükségmenet áramkörei üzemben

#Spawner
Spawner.502.TypeNVL         = Vonat az NVL-ből
Spawner.502.TypeKVLO        = Régi vonat a KVL-ből
Spawner.502.TypeKVLN        = Új vonat a KVL-ből
Spawner.502.EWagons         = "E" típusú közbenső kocsik hozzáadása

#gmod_subway_81-502
Entities.gmod_subway_81-502.Buttons.VBA.VBAToggle = Automatikus vonatvezérlés akkumulátor(be/ki)

Entities.gmod_subway_81-502.Buttons.AV.VRUToggle = VRU: Szükségmenet
Entities.gmod_subway_81-502.Buttons.AV.KPVUToggle = KPVU: Pneumatikus vezérlés kikapcsoló
Entities.gmod_subway_81-502.Buttons.AV.KSDToggle = KSD: Ajtó reteszelő egység vezérlés kikapcsoló
...
Entities.gmod_subway_81-502.Buttons.RCAV3.RCAV3Toggle           = KSAUP áramkör szakaszoló (AV3)
Entities.gmod_subway_81-502.Buttons.RCAV4.RCAV4Toggle           = KSAUP áramkör szakaszoló (AV4)
Entities.gmod_subway_81-502.Buttons.RCAV5.RCAV5Toggle           = KSAUP áramkör szakaszoló (AV5)
