...
#Cameras:
Train.722.Breakers      = Автоматические выключатели
Train.722.PU2_1         = Панель кнопок
Train.722.PU2_2         = Вспомогательный пульт
Train.722.Vityaz        = Монитор САУ "ВИТЯЗЬ-СП"
...
Common.722.EmergencyDrive               = Резервный пуск в режиме аварийного хода
Common.722.Microphone                   = Включение микрофона
Common.722.LRS                          = Лампа аварийного питания радиостанции от батареи
Common.722.LAVS                         = Лампа низкого давления в тормозной магистрали
Common.722.LRU                          = Лампа выключенного состояния реле управления
Common.722.GlassWasher                  = Омыватель стекла
Common.722.GlassCleaner                 = Стеклоочиститель
Common.722.EmergencyBrakeTPlus          = Аварийный тормоз (режим Т+)
Common.722.EmergencyBrakeTPlusK         = Крышка кнопки "Аварийный тормоз"
Common.722.KRO                          = Направление движения

Common.722.PSNToggle                    = Включение зарядки батареи от внешнего источника
Common.722.BattOn                       = Включение источника питания бортовой сети
Common.722.BattOff                      = Отключение источника питания бортовой сети
Common.722.TorecDoorUnlock              = Разблокировка торцевых дверей
Common.722.SCEnabled                    = Лампа включения короткозамыкателя
Common.722.LSOSD                        = Лампа работы светильника открытия станционных дверей

Common.722.PassVent                     = Включение вентиляции салона
Common.722.VRU                          = Переключение режимов управления
Common.722.VADToggle                    = Движение без контроля дверей
Common.722.VAHToggle                    = Движение без педали бдительности
Common.722.EmergencyRadioPowerToggle    = Аварийное питание радиостанции
Common.722.BARSMode                     = Переключатель полукомплектов БАРС
Common.722.PantSC                       = Токоприёмники и короткозамыкатель

Common.SARMAT.Up                        = САРМАТ: Вверх
Common.SARMAT.Down                      = САРМАТ: Вниз
Common.SARMAT.Enter                     = САРМАТ: Enter
Common.SARMAT.Esc                       = САРМАТ: Esc
Common.SARMAT.F1                        = САРМАТ: F1
Common.SARMAT.F2                        = САРМАТ: F2
Common.SARMAT.F3                        = САРМАТ: F3
Common.SARMAT.F4                        = САРМАТ: F4
Common.SARMAT.Path                      = САРМАТ: Путь
Common.SARMAT.Line                      = САРМАТ: Линия
Common.SARMAT.Zero                      = САРМАТ: Установка в начало
Common.SARMAT.Start                     = САРМАТ: Пуск

#Autobreakers
Common.722.SF1                          = SF1: Бортовая сеть (управление)
Common.722.SF2                          = SF2: Активная кабина
Common.722.SF3                          = SF3: Управление основное
Common.722.SF4                          = SF4: Управление резервное
Common.722.SF5                          = SF5: Управление РВТБ
Common.722.SF6                          = SF6: Питание крана машиниста
Common.722.SF7                          = SF7: Управление дверьми
Common.722.SF8                          = SF8: БАРС 1
Common.722.SF9                          = SF9: БАРС 2
Common.722.UPO                          = SF: УПО1
Common.722.SF10                         = SF10: БРПИ-М1
Common.722.SF11                         = SF11: БРПИ-М2
Common.722.SF12                         = SF12: Пожарная система
Common.722.SF13                         = SF13: Токоприёмник, короткозамыкатель
Common.722.SF14                         = SF14: Радиосвязь 1
Common.722.SF15                         = SF15: Радиосвязь 2
Common.722.SF16                         = SF16: ЦИС 1 (монитор)
Common.722.SF17                         = SF17: ЦИС 2 (цифровой информационный комплекс)
Common.722.SF18                         = SF18: ЦИС 3
Common.722.SF19                         = SF19: БУКП, УПИ
Common.722.SF20                         = SF20: Монитор
Common.722.SF21                         = SF21: Ориентация
Common.722.SF22                         = SF22: Габаритные огни от батареи
Common.722.SF23                         = SF23: Фары, габаритные огни
Common.722.SF24                         = SF24: Светильник открытия станционных дверей
Common.722.SF25                         = SF25: Освещение кабины
Common.722.SF26                         = SF26: Кондиционер кабины
Common.722.SF27                         = SF27: Стеклоочиститель, омыватель, тифон

Common.722.SF31                         = SF31: Поездной питающий провод
Common.722.SF32                         = SF32: Бортовая сеть управление
Common.722.SF33                         = SF33: Питание цепей управления
Common.722.SF34                         = SF34: ЦИС по левой стороне
Common.722.SF35                         = SF35: ЦИС по правой стороне
Common.722.SF36                         = SF36: Бортовая сигнализация
Common.722.SF37                         = SF37: Отжатие токоприёмников
Common.722.SF38                         = SF38: Резерв
Common.722.SF41                         = SF41: Двери открытие левые
Common.722.SF42                         = SF42: Двери открытие правые
Common.722.SF43                         = SF43: Двери закрытие
Common.722.SF44                         = SF44: Двери торцевые
Common.722.SF45                         = SF45: Освещение салона питание
Common.722.SF46                         = SF46: Освещение салона аварийное
Common.722.SF47                         = SF47: Вентиляция 1 группа
Common.722.SF48                         = SF48: Вентиляция 2 группа
Common.722.SF49                         = SF49: Счётчик
Common.722.SF51                         = SF51: Блок управления вагоном
Common.722.SF52                         = SF52: БОДВ
Common.722.SF53                         = SF53: Преобразователь собственных нужд
Common.722.SF54                         = SF54: Осушитель
Common.722.SF55                         = SF55: Блок управления фрикционным тормозом
Common.722.SF56                         = SF56: Инвертор
Common.722.SF57                         = SF57: Обогрев инвертора
Common.722.SF58                         = SF58: Цепи управления вагоном основное питание
Common.722.SF59                         = SF59: Цепи управления вагоном резервное питание
